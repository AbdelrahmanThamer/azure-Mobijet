      ...
      Chip(
        ...
        label: MtCustomfontBoldSemi(
          text: mssg.tktMssgSENDBY == customerUID
              ...
              : " ${getTranslatedForCurrentUser(context, 'xxxxisclosedbyxxx').replaceAll('(####)', '${getTranslatedForCurrentUser(context, 'xxtktsxx')}').replaceAll('(###)', '${getTranslatedForCurrentUser(context, 'xxagentxx')}')} ",
