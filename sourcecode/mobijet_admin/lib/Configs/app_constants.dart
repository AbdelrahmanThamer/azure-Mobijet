...
//*--- Only Change all these fileds below for Reskin.
  ...
  static String appFolderNameinAndroid =
      'Mobijet Downloads'; //Folder Name in Users device Storage for Android Storage
  static String defaultcountrycodeISO =
      'US'; //Default Country 2 letter ISO in Search User page
  static String defaultcountrycodeMobileExtension =
      '+1'; //Default Country Code in Search User page
  ...
  static String demoadminemail = "admin@demo.com";
